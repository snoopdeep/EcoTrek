    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          console.log(res); // if(!res.cookies.jwt){console.log('No cookie is found');location.reload(true)};
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            console.log('this is after successful password updation.. going to show the alert..');
...
console.log('Hi from index.js'); //PAYMENT;
