...
var hideAlert = exports.hideAlert = function hideAlert() {
  ...
  var el = document.querySelector('.alert'); // el.parentElement=> body
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // console.log('this is from show alert');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You have signup successfully. Welcome to EcoTrek!!');
            window.setInterval(function () {
              location.assign('/');
            }, 500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            // show alert
            (0, _alert.showAlert)('success', 'Data Updated Successfully!'); // reload the current user page;
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(passwordCurrent, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            // );
            (0, _alert.showAlert)('success', 'Password changed Successfully!'); // reload the current user page;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          }, 1500); // THIS IS PUBLIC STRIPE KEY USED FOR REDIRECTING TO THE SESSION URL -> BUT I'M NOT USING IT COZ IT 
...
var signUpBtn = document.querySelector('.form--signup'); // console.log(loginForm);
...
if (updateUserForm) {
  updateUserForm.addEventListener('submit', function (e) {
    ...
    formData.append('photo', document.getElementById('photo').files[0]); // const name = document.getElementById('name').value;
    // const email = document.getElementById('email').value;
    // console.log('FormData is ..', formData);
    // console.log('Submitted for updating user name and email..');

    (0, _updateSettings.updateUser)(formData);
  });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            e.preventDefault();
            document.querySelector('.saving--password--btn ').textContent = 'Updating...';
          ...
          case 7:
            document.querySelector('.saving--password--btn ').textContent = 'Save Password';
